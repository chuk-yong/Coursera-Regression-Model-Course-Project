...
In order to make a better decision on what other variables could possible impact mpg, we made a pairplot.  Results are shown in Appendix.
...
We will fit in the variables and see if the introduction improves on our original fit.

##Appendix

#Pair Plots
This is a pair plot showing the relationship between all the variables.
```{R}
